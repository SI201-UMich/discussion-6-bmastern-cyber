...
###############################################################################
    def load_results(self, table):
        ...
        for item in items:
            ...
            value_2 = item[2]
            value_3 = item[3]
            output[horse_name] = {header[1]: float(value_1),
                                  header[2]: float(value_2),
                                  header[3]: float(value_3)}
...
###############################################################################
    ...
    def horse_personal_best(self):
        ...
        for horse in self.race_dict.keys():
            horse_dict[horse] = self.horse_fastest_race(horse)
        return horse_dict
...
###############################################################################
    ...
    def get_average_time(self):
        ...
        for horse in self.race_dict:
             horse_dict[horse] = sum(self.race_dict[horse].values()) / len(self.race_dict[horse].values())
        return horse_dict
